...
import (
	...
	contractPriceAggregatorTaskManager "github.com/Layr-Labs/incredible-squaring-avs/contracts/bindings/PriceAggregatorTaskManager"
...
func (m *MockAvsWriterer) RaiseChallenge(arg0 context.Context, arg1 contractPriceAggregatorTaskManager.IPriceAggregatorTaskManagerTask, arg2 contractPriceAggregatorTaskManager.IPriceAggregatorTaskManagerTaskResponse, arg3 contractPriceAggregatorTaskManager.IPriceAggregatorTaskManagerTaskResponseMetadata, arg4 []contractPriceAggregatorTaskManager.BN254G1Point) (*types0.Receipt, error) {
	m.ctrl.T.Helper()
...
func (m *MockAvsWriterer) SendAggregatedResponse(arg0 context.Context, arg1 contractPriceAggregatorTaskManager.IPriceAggregatorTaskManagerTask, arg2 contractPriceAggregatorTaskManager.IPriceAggregatorTaskManagerTaskResponse, arg3 contractPriceAggregatorTaskManager.IBLSSignatureCheckerNonSignerStakesAndSignature) (*types0.Receipt, error) {
	m.ctrl.T.Helper()
...
func (m *MockAvsWriterer) SendNewTaskNumberToSquare(arg0 context.Context, arg1 *big.Int, arg2 types.QuorumThresholdPercentage, arg3 types.QuorumNums) (contractPriceAggregatorTaskManager.IPriceAggregatorTaskManagerTask, uint32, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendNewTaskNumberToSquare", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].(contractPriceAggregatorTaskManager.IPriceAggregatorTaskManagerTask)
	ret1, _ := ret[1].(uint32)
	ret2, _ := ret[2].(error)
