...
cli-generate-new-operator-keys:
	go run cli/main.go --config config-files/operator.anvil.yaml generate-operator-keys
...
run-plugin: ## 
	go run plugin/cmd/main.go --config config-files/operator-1.anvil.yaml
-----------------------------: ## 
_____HELPER_____: ## 
